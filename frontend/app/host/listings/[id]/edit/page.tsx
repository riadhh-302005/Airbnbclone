  ...
  if (isLoading) {
    return (
      <div className="min-h-screen flex flex-col bg-white">
        <Navbar />
        <div className="max-w-4xl mx-auto px-4 py-20 flex-1 w-full animate-pulse space-y-6">
    ...
    <div className="flex flex-col min-h-screen bg-white">
      ...
      <main className="flex-1 max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 w-full">
        ...
        <div className="flex items-center gap-3 mb-8">
          <Edit3 className="w-8 h-8 text-sky-600" />
          <h1 className="text-3xl font-black text-neutral-900">Edit Property Listing</h1>
        </div>

        <form onSubmit={handleSubmit} className="space-y-8 bg-neutral-50 p-8 rounded-3xl border border-neutral-200">
          {/* Basics Section */}
          <div className="space-y-4">
            <h3 className="text-lg font-bold text-neutral-900 border-b border-neutral-200 pb-2">Basic Overview</h3>
            <div>
          ...
          <div className="space-y-4 pt-4 border-t border-neutral-200">
            <h3 className="text-lg font-bold text-neutral-900 border-b border-neutral-200 pb-2">Pricing & Capacity</h3>
          ...
          {/* Amenities Selection */}
          <div className="space-y-4 pt-4 border-t border-neutral-200">
            <h3 className="text-lg font-bold text-neutral-900 border-b border-neutral-200 pb-2">Amenities</h3>
          ...
          {/* Photos */}
          <div className="space-y-4 pt-4 border-t border-neutral-200">
            <h3 className="text-lg font-bold text-neutral-900 border-b border-neutral-200 pb-2">Photos (URLs)</h3>
          ...
          <div className="pt-6 border-t border-neutral-200 flex justify-end gap-4">
            ...
            <button
              ...
              className="bg-neutral-900 hover:bg-black text-white font-bold px-8 py-3.5 rounded-2xl transition shadow-lg text-sm disabled:opacity-50"
            >
